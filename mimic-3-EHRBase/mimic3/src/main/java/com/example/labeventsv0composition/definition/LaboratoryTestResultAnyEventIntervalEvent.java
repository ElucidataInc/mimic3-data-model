...
@Generated(
    ...
    date = "2024-03-29T13:40:13.464782+05:30",
...
public class LaboratoryTestResultAnyEventIntervalEvent implements IntervalEventEntity, LaboratoryTestResultAnyEventChoice {
  ...
  /**
   * Path: labevents.v0/Laboratory test result/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: labevents.v0/Laboratory test result/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: labevents.v0/Laboratory test result/Any event/sample_count
   */
  @Path("/sample_count")
