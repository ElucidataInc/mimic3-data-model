...
public class LaboratoryTestResultObservationContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> RECEIVING_LABORATORY = new ListAqlFieldImp<Cluster>(LaboratoryTestResultObservation.class, "/protocol[at0004]/items[at0017]", "receivingLaboratory", Cluster.class, this);
