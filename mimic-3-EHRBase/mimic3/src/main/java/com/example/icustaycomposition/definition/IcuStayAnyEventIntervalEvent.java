...
@Generated(
    ...
    date = "2024-04-02T12:01:58.697288+05:30",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
@OptionFor("INTERVAL_EVENT")
public class IcuStayAnyEventIntervalEvent implements IntervalEventEntity, IcuStayAnyEventChoice {
  /**
  ...
  /**
   * Path: icustay/ICU Stay/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: icustay/ICU Stay/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: icustay/ICU Stay/Any event/sample_count
   */
  @Path("/sample_count")
